...
--
-- Dumping data for table `ixaddress`
--
...
CREATE TABLE `ixmarked` (
  ...
  `cpanid` varchar(255) DEFAULT NULL,
  `markdate` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IXADDR` (`addressid`),
  KEY `IXPAUSE` (`cpanid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `users` VALUES (1,5,1,'','Master','master@example.com','admin','e1585f6bf9aadaf9d94477fc60449ca884f6083e','',0,'');
INSERT INTO `users` VALUES (2,1,1,'','Guest','GUEST','public','c8d6ea7f8e6850e9ed3b642900ca27683a257201','',1,'');
INSERT INTO `users` VALUES (3,2,1,'','PAUSE','PAUSE','pause','9935dfb5a4d397598918b95cafea8828afe115be','',0,'');
...
-- Dump completed on 2014-01-05 19:38:00
